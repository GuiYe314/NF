...
public static class CreatNewCShapScript
{
    ...
    public static void CreatMonoBehaviourScript()
    {
        ...
        "Assets/1_NFramework/Editor/CustomScriptTemplate/C# Script-NewMonoBehaviourScript.txt");
    }
    ...
    public static void CreatMonoBehaviourScriptPartial()
    {
        ...
        ScriptableObject.CreateInstance<CreateNewCShapScriptAsset>(),
        GetSelectPathOrFallback() + "/NewNoMonoBehaviourScript.cs", null,
        "Assets/1_NFramework/Editor/CustomScriptTemplate/C# Script-NewMonoBehaviourScript-partial.txt");
    }
    ...
    public static void CreatNoMonoBehaviourScript()
    {
        ...
        ScriptableObject.CreateInstance<CreateNewCShapScriptAsset>(),
        GetSelectPathOrFallback() + "/NewNoMonoBehaviourScript.cs", null,
        "Assets/1_NFramework/Editor/CustomScriptTemplate/C# Script-NewNoMonoBehaviourScript.txt");
    }
    ...
    public static void CreatNoMonoBehaviourScripPartial()
    {
        ...
        ScriptableObject.CreateInstance<CreateNewCShapScriptAsset>(),
        GetSelectPathOrFallback() + "/NewNoMonoBehaviourScript.cs", null,
        "Assets/1_NFramework/Editor/CustomScriptTemplate/C# Script-NewNoMonoBehaviourScript-partial.txt");
    }
    ...
    public static void CreatGFProcedure()
    {
        ...
        ScriptableObject.CreateInstance<CreateNewCShapScriptAsset>(),
        GetSelectPathOrFallback() + "/NewNoMonoBehaviourScript.cs", null,
        "Assets/1_NFramework/Editor/CustomScriptTemplate/C# Script-NewGFProcedure.txt");
    }
    ...
    public static void CreatGFComponent()
    {
        ...
        ScriptableObject.CreateInstance<CreateNewCShapScriptAsset>(),
        GetSelectPathOrFallback() + "/NewNoMonoBehaviourScript.cs", null,
        "Assets/1_NFramework/Editor/CustomScriptTemplate/C# Script-NewGFComponent.txt");
    }
