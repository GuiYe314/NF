// **********************************************************************
// 文件信息
// 文件名(File Name):                FrameworkLinkedList.cs
// 作者(Author):                     王云超
// 创建时间(CreateTime):             2024年5月27日 14:18:59
// Unity版本(UnityVersion)：         2021.3.38f1c1
// 脚本描述(Module description       框架链表类
...
namespace F.Librarie
{
    ...
    /// 框架链表类
    /// </summary>
    public class FrameworkLinkedList<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
    {
